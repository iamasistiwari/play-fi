import { Users, Crown, Github, Radio } from "lucide-react";
...
export default function Home() {
  return (
    <main className="min-h-screen">
      <nav>
        <div className="flex h-[72px] items-center justify-between border-b border-neutral-800 px-4 lg:px-32 py-2">
          ...
          <div>
            <Link
              href={`/signin`}
              className="border-neutral-300 hover:cursor-pointer bg-blue-800 px-10 py-2 text-neutral-200 transition-colors duration-200 hover:bg-blue-900"
            >
              Signin
            </Link>
          </div>
      ...
      <section className="relative bottom-10 flex h-screen items-center justify-center px-4 text-center">
        <div className="mx-auto max-w-5xl">
          <h1 className="mb-10 text-6xl font-bold md:text-7xl">
            ...
            <span className="text block ml-4 bg-gradient-to-r from-blue-500 to-green-600 bg-clip-text text-transparent">
              Play-Fi
            </span>
          </h1>
